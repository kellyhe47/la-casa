...
**Hard prohibitions:** no text labels on store shelf items (pictures only); no save/progress indicators of any kind (nothing persists); no XP/meters/scores; no red X or error styling anywhere; no gradients outside the sanctioned light-glow exception above; no drop shadows; no third-person Sofía; no "new story" control on the title screen (removed 2026-07-29).
